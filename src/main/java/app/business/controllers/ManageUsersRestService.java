...
import app.business.controllers.UserManage;
...
public class ManageUsersRestService {
	...
	public List<UserManage> getUserList(@PathVariable String org) {
		...
		// Add a method to get userlist by organization
	...
	public UserManage addNewUser(@PathVariable String org, @RequestBody Map<String,String> newUserDetails) {
		...
		// Add the Organization Membership for the User
		// I'll need a function here to parse the string role to decide the authorization
		// Use below code when you change the role select element to multiple checkbox
		/*String delims = "[ ]+";
		String[] tokens = role.split(delims);*/
		...
		int manageUserID = user.getUserId();
		System.out.println("The new manage user id is: " + manageUserID);
		
		UserManage userrow = new UserManage(manageUserID, name, email, phone, role, address);
		
		System.out.println("Successfully Created the userrow object.");
	...
	public void addRole(@PathVariable String org, @RequestBody Map<String,String> userDetails) {
		  ...
		  System.out.println("Added Roles susccessfully");
	}
	...
	public void removeRole(@PathVariable String org, @RequestBody Map<String,String> userDetails) {
		  ...
		  System.out.println("removeRole = " + removeRole);
		  ...
		  System.out.println("Removed Roles susccessfully");
	}
	...
	public void editUser(@PathVariable String org, @RequestBody Map<String,String> currentUserDetails) {
		...
		System.out.println("Successfully Updated the details for the Current User");
	...
	public Map<String, Vector<String> > getUserDetails(@PathVariable String org, @RequestBody int manageUserId) {
		...
		System.out.println("The Request body from AngularJS is " + manageUserId);
		...
		System.out.println("primary number is : " + userPhoneNumbers.get(0));
		...
		System.out.println("Successfully Got the details for the Current User");
